...
**一句话安装单个技能 — 直接告诉 AI：**
> 去 GitHub `shijieweb/solo-skills` 安装 **agentmemory** 这个技能
...
| **agentmemory** | ✅ 依赖 agentmemory MCP | MCP 缺失时降级为纯文件模式 + standalone.json 回退 |
